...
export const Hero: React.FC = () => {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-0 lg:min-h-[440px]">
      <div className="space-y-8">
        ...
        <div className="flex flex-wrap items-center gap-4 pt-4">
          ...
          <button
            ...
            className="group relative inline-flex h-12 shrink-0 items-center justify-center whitespace-nowrap overflow-hidden rounded-md bg-zinc-900 dark:bg-zinc-100 px-6 text-base font-medium text-zinc-50 dark:text-zinc-900 transition-all hover:bg-zinc-800 dark:hover:bg-zinc-200 focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:focus:ring-zinc-400 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-zinc-900"
          >
          ...
          <a
            href="/resume.pdf"
            download
            className="group relative inline-flex h-12 shrink-0 items-center justify-center whitespace-nowrap overflow-hidden rounded-md border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 px-6 text-base font-medium text-zinc-900 dark:text-zinc-100 transition-all hover:bg-zinc-50 dark:hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:focus:ring-zinc-400 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-zinc-900"
          >
